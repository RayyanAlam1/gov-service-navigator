  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        // Buttons carry a hairline top highlight and a tight ground shadow, so
        // a primary action reads as a physical control rather than a coloured
        // rectangle. Tuned against the accent, not black, so it stays warm.
        control: 'inset 0 1px 0 rgb(255 255 255 / 0.15), 0 1px 2px rgb(3 74 54 / 0.26)',
        'control-hover': 'inset 0 1px 0 rgb(255 255 255 / 0.20), 0 3px 8px rgb(3 74 54 / 0.28)',
      },
